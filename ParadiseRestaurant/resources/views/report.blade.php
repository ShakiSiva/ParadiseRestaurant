        ...
        <div class="panel">
            ...
            <div class="body">
                ...
                <div class="tab-window">
                    <div class="tabs">
                        ...
                        <a style="background-color:green" href="/reports">Reports</a>
                    </div>
                    <div class="content">
                        <h2>Daily Revenue</h2>
                        <table>
                    ...
                    <div class="content">
                        <h2>Most Famous Side Dish with Main Dish</h2>
                        <table>
                            <thead>
                                <tr>
                            ...
                            <tbody>
                            @foreach($topSideDishWithMainDishes as $key => $dish)
                                    <tr>
                                        <td>{{ $dish->side_dish_name }}</td>
                                        <td>{{ $dish->main_dish_name }}</td>
                                        <td>{{ $dish->count }}</td>
            ...
            <div>
                <form action="/logout" method="post">
                    @csrf
                    <input id="LogOut" type="submit" style="font-weight: bold" value='logout'>
                </form>
            </div>
